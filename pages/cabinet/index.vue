...
<!--                  </div>-->
                ...
                <div class="guide-list__item-content">
                  ...
                  <div class="guide-list__item-about">
                    <NuxtLink style="color: white!important;" :to="'/places/'+item.alias" class="guide-list__about-link mt-3">{{ $t('more_info') }}</NuxtLink>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="souvenirs__items-inner__cabinet">
              <div class="souvenirs__item" v-for="(item,i) in souvenirs" :key="i">
                ...
                <div class="souvenirs__item-content">
                  ...
                  <div class="souvenirs__item-price-wrapper mt-3">
                    <v-dialog
                      v-if="item.eventum"
                      v-model="dialog"
                    >
