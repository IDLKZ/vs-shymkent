    ...
    <div class="container">
      ...
      <div class="routes-item__wrapper">
        <div class="routes-item__info-content">
          ...
          <div class="routes-item__guide">
            Гиды:
            <a href="#">Кайрат Карибаев</a>
            <a href="#">Елена Белова</a>
            <a href="#">Хамидов Улукбек</a>
          </div>
...
<!--                </a>-->
          ...
          <div class="load-more">
            <a href="#">Перейти ко всем маршрутам</a>
          </div>
        </div>
...
export default {
  ...
  async asyncData({$axios,route,redirect,store}) {
    ...
    // console.log(placemarks)
    return {Route,galleries,placemarks,points};
  },
  mounted() {
