...
<!--                </button>-->
            ...
            <div class="tour-guide__content-feedback">
              <div class="tour-guide__content-feedback-item tour-guide__content-feedback-item--rating">
              ...
              <div class="tour-guide__content-feedback-item">
                ...
                <div class="tour-guide__feedback-reviews">
                  <div class="tour-guide__reviews-inner">
                    <div class="tour-guide__reviews-item">
                      <div class="tour-guide__reviews-item-top">
                        <div class="tour-guide__reviews-item-img" style="background-image: url('/images/kayrat.jpg');"></div>
                        <div class="tour-guide__reviews-item-inner">
                          <div class="tour-guide__reviews-inner-name">
                      ...
                      <div class="tour-guide__reviews-item-text">
                  ...
                  <a href="#reviews-form" class="tour-guide__reviews-btn reviews-btn">Добавить отзыв</a>
                </div>
              </div>
            </div>
          </div>
