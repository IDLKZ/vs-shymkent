            ...
            <div class="guide-list__accordion">
              <div class="guide-list__accordion-item">
                <div class="guide-list__accordion-trigger">
                  <input @click="allCheck" ref="check" class="check-all" type="checkbox" id="cb0"><label for="cb0">Все</label>
                </div>
              </div>
              <div class="guide-list__accordion-item" v-for="(item,i) in this.categories" :key="i">
                <div class="guide-list__accordion-trigger">
                  <input ref="check" class="check-all" type="checkbox" :id="'cb'+item.id"> <label :for="'cb'+item.id">{{item['title_'+$i18n.locale]}}</label>
