              ...
              <div>
                ...
                <div class="guide-item__rating-inner">
                  <div class="guide-list__item-rating">
                    <star-rating :rating="place.ratings_avg_rating" star-size="16" :read-only="true" :round-start-rating="false" :show-rating="false"></star-rating>
                  </div>
                  <div class="guide-item__contact-count">
                    ({{place.ratings_avg_rating !== null ?place.ratings_avg_rating.toFixed(1) : 0}})
                  </div>
                </div>
              </div>
              <div>
                ...
                <div class="guide-item__rating-inner">
                  <div class="guide-list__item-rating">
                    <star-rating :rating="place.reviews_avg_rating" star-size="16" :read-only="true" :round-start-rating="false" :show-rating="false"></star-rating>

                  </div>
                  <div class="guide-item__contact-count">
                    ({{place.reviews_avg_rating !== null ?place.reviews_avg_rating.toFixed(1) : 0 }})
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="guide-list__item" v-for="(item,i) in places" :key="i">
                    ...
                    <div class="d-flex justify-space-around my-2">
                      <div>
                        ...
                        <div class="guide-item__rating-inner">
                          <div class="guide-list__item-rating">
                            <star-rating :rating="item.ratings_avg_rating" star-size="16" :read-only="true" :round-start-rating="false" :show-rating="false"></star-rating>
                          </div>
                          <div class="guide-item__contact-count">
                            ({{item.ratings_avg_rating !== null ?item.ratings_avg_rating.toFixed(1) : 0}})
                          </div>
                        </div>
                      </div>
                      <div>
                        ...
                        <div class="guide-item__rating-inner">
                          <div class="guide-list__item-rating">
                            <star-rating :rating="item.reviews_avg_rating" star-size="16" :read-only="true" :round-start-rating="false" :show-rating="false"></star-rating>
                          </div>
                          <div class="guide-item__contact-count">
                            ({{item.reviews_avg_rating !== null ?item.reviews_avg_rating.toFixed(1) : 0 }})
                          </div>
                        </div>
                      </div>
                    </div>
