    ...
    <section class="souvenirs-item">
      <div class="container">
        <ul class="crumbs">
          ...
          <li class="crumbs__item">
            <NuxtLink to="/craftman">Ремесленники</NuxtLink>
          </li>
        ...
        <div class="souvenirs-item__wrapper">
          <div class="souvenirs-item__img" :style="'background-image: url('+getImages(craftman.image)+');'"></div>
              ...
              <div class="tour-agency__content-info-item">
                ...
                <ul class="tour-agency__contact">
                  ...
                  <li>
                    ...
                    <div class="tour-agency__contact-text">
                                        <span>
                                            <a href="mailto:sanya_93_93.20@mail.ru">{{ craftman.user.email }}</a>
                                        </span>
                    </div>
                  </li>
                  <li>
...
<!--                </button>-->
    ...
    <section class="souvenirs">
      <div class="container">
        ...
        <div class="load-more">
          <a href="#">Перейти ко всем ремеслиникам</a>
        </div>
      </div>
    </section>
  </div>
...
export default {
  ...
  async asyncData({$axios,route,redirect,store}) {
    ...
    return {craftman,souvenirs,form,saveColor};
  }
}
</script>
